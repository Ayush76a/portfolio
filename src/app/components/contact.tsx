...
const Contact = () => {
  return (
    <div id='Contact'>
        <section className="text-gray-600 body-font relative bg-gray-800">
        <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
            ...
            <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                ...
                <p className="mt-1">
                    566/79, Jai Prakash Nagar, Alambagh, Lucknow, UttarPradesh, PIN-226005
                </p>
                </div>
            ...
            <p className="text-xs text-gray-500 mt-3">
                Feeling Low, Plan a trip and Visit Nawabo ka Shaher!
            </p>
            </div>
        </div>
        </section>
